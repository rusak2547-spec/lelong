    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950">
      ...
      >
         ...
         <div className="container relative z-10 mx-auto px-4 text-center max-w-4xl">
            ...
            <p className="text-xl md:text-2xl mb-10 max-w-2xl mx-auto leading-relaxed" style={{ color: '#d4d4d8' }}>
               {tHero('subtitle')} <br/>
               <span className="font-medium px-2 rounded" style={{ color: '#facc15', backgroundColor: 'rgba(0,0,0,0.3)' }}>{tHero('highlight')}</span>
            </p>
         ...
         {products.length > 0 ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8">
             ...
             <div className="text-center py-32 bg-white dark:bg-zinc-900 rounded-2xl border border-dashed border-zinc-300 dark:border-zinc-800">
                ...
                <p className="text-zinc-500 mt-2 max-w-sm mx-auto">{tHome('noProducts')}</p>
                {category && (
      ...
      <footer className="border-t py-12 bg-white dark:bg-zinc-950">
          <div className="container mx-auto px-4 text-center">
             <div className="mb-6">
                <span className="font-bold text-2xl tracking-tighter">Pawnshop Brunei</span>
             </div>
             <p className="text-zinc-500 text-sm max-w-md mx-auto mb-6">
                Platform lelongan emas dan gadget terpercaya di Brunei Darussalam. Harga kompetitif, barang berkualitas, dan transaksi aman.
             </p>
             <div className="text-sm text-zinc-400">
                &copy; {new Date().getFullYear()} Pawnshop Brunei. All rights reserved.
             </div>
          </div>
      </footer>
    </div>
